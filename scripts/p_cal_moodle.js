...
(function () {
	function C(c, d) {
		return () => new Promise((e, b) => {
			...
			chrome.runtime.getBackgroundPage(k => k.TE_forcedAutoLogin(!0).then(() => l.XHR(m, "document").then(a).catch(b)).catch(b))
		})
	}
	...
	function x(c) {
		chrome.storage.local.get({calendar_prop: ""}, function (d) {
			if (chrome.runtime.lastError) console.log("TE_cal1: " + chrome.runtime.lastError.message), c({
				...
				// שגיאה בניסיון לגשת לנתוני הדפדפן, אנא נסה שנית.
				is_error: !0
			}); else if ("" === d.calendar_prop) {
				var e = () => c({
					msg: "\u05d0\u05d9\u05e8\u05e2\u05d4 \u05e9\u05d2\u05d9\u05d0\u05d4 \u05d1\u05e0\u05d9\u05e1\u05d9\u05d5\u05df \u05dc\u05d2\u05e9\u05ea \u05d0\u05dc \u05e9\u05e8\u05ea \u05d4-Moodle, \u05d0\u05e0\u05d0 \u05e0\u05e1\u05d4 \u05e9\u05e0\u05d9\u05ea \u05de\u05d0\u05d5\u05d7\u05e8 \u05d9\u05d5\u05ea\u05e8.",
					// אירעה שגיאה בניסיון לגשת אל שרת ה-Moodle, אנא נסה שנית מאוחר יותר.
					is_error: !0
				});
	...
	l.css_list = ["calendar"];
	l.popupWrap();
	var r = new CalendarCommon(l, "moodle");
		...
		chrome.storage.local.get({
			...
			function (b) {
				chrome.runtime.lastError ? (console.log("TE_cal: " + chrome.runtime.lastError.message), e({
					...
					// שגיאה בניסיון לגשת לנתוני הדפדפן, אנא נסה שנית.
					is_error: !0
				})) : "" === b.calendar_prop ? chrome.runtime.getBackgroundPage(a => a.TE_loginToMoodle(!0).then(() => x(e)).catch(() => e({
					msg: "\u05dc\u05e4\u05e0\u05d9 \u05de\u05e9\u05d9\u05db\u05ea \u05d4\u05de\u05d8\u05dc\u05d5\u05ea \u05d4\u05e8\u05d0\u05e9\u05d5\u05e0\u05d9\u05ea \u05de\u05d4\u05de\u05d5\u05d3\u05dc \u05d9\u05e9 \u05dc\u05d4\u05db\u05e0\u05e1 \u05d0\u05dc \u05d4\u05de\u05d5\u05d3\u05dc \u05d5\u05dc\u05d5\u05d5\u05d3\u05d0 \u05e9\u05d4\u05d4\u05ea\u05d7\u05d1\u05e8\u05d5\u05ea \u05d1\u05d5\u05e6\u05e2\u05d4 \u05d1\u05d0\u05d5\u05e4\u05df \u05ea\u05e7\u05d9\u05df.",
					// לפני משיכת המטלות הראשונית מהמודל יש להכנס אל המודל ולוודא שההתחברות בוצעה באופן תקין.
					is_error: !0
				}))) : l.XHR("https://moodle24.technion.ac.il/calendar/export_execute.php?preset_what=all&preset_time=recentupcoming&" + b.calendar_prop, "text").then(a => {
					if ("Invalid authentication" == a.response.trim()) chrome.storage.local.set({calendar_prop: ""}), chrome.runtime.getBackgroundPage(f => f.TE_loginToMoodle(!0).then(() => x(e)).catch(() => e({
						msg: "\u05dc\u05d0 \u05e0\u05d9\u05ea\u05df \u05dc\u05de\u05e9\u05d5\u05da \u05de\u05d8\u05dc\u05d5\u05ea \u05de\u05d4\u05de\u05d5\u05d3\u05dc. \u05e0\u05e1\u05d4 \u05e9\u05e0\u05d9\u05ea \u05de\u05d0\u05d5\u05d7\u05e8 \u05d9\u05d5\u05ea\u05e8, \u05d0\u05dd \u05d4\u05ea\u05e7\u05dc\u05d4 \u05e0\u05de\u05e9\u05db\u05ea - \u05e6\u05d5\u05e8 \u05e7\u05e9\u05e8 \u05e2\u05dd \u05d4\u05de\u05e4\u05ea\u05d7.",
						// לא ניתן למשוך מטלות מהמודל. נסה שנית מאוחר יותר, אם התקלה נמשכת - צור קשר עם המפתח.
						is_error: !0
