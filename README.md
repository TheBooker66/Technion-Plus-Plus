...
בדפדפנים המבוססים עליו (למשל דפדפני Opera ו־Microsoft Edge), אלא אם ההורדה היא למטרות פיתוח התוסף, ואז המשתמש רשאי לעשות
כרצונו בהתאם למגבלות רישיון MIT. השימוש בתוסף שלא למטרות פיתוחו מהווה אישור לכך שהמשתמש קרא את מדיניות הפרטיות
