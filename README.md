...
לאימייל הטכניוני, ו/או מספר תעודת זהות**. אם המידע נמחק מהתוסף (על ידי דף ההגדרות) הוא נמחק כליל ולא נשמר בשום מקום.
פרטי המשתמש וההגדרות שבשימוש התוסף נשמרים בזיכרון הדפדפן של המשתמש בלבד ולא נשלחים לאף שרת (למעט שרתים רשמיים של
הטכניון)וכמובן שלא לאף צד ג'. יש להבהיר שוב כי התוסף לא שולח שום מידע לשום מקום; **כל המידע נותר לוקאלית על המחשב של
המשתמש**.
