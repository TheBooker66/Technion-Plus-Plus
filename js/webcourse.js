...
(function () {
	...
	for (a = 0; a < l.length; a++) "wc_output" == l[a].getAttribute("target") && l[a].setAttribute("target", "_blank");
	if (window.location.href.includes("ho.html") || -1 != window.location.href.search("ho_.*.html")) for (l = document.getElementsByClassName("tickets"), a =
		0; a < l.length; a++) {
		let g = [], h = [], e = [], w = [], k = [], n = l[a].getElementsByClassName("ticket");
		...
		let d;
		0 < g.length + h.length + e.length + k.length &&
		...
		q(k, d, "הכל", a), q(g, d, "PDF", a), q(h, d, "PowerPoint", a), q(e, d, "Word", a), q(w, d, "ZIP", a),
