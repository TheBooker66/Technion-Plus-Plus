...
(function () {
    ...
    <div style="margin-bottom: 1em; border-width: 2px 0px; border-image: linear-gradient(to ${b.grad_dir[a]}, hsl(208, 90%, 23%), transparent) 1; width: max-content;padding: ${b.padding[a]}; border-style: solid;">
